...
module.exports = function* (table, db) {
  ...
  */
   ...
   */
		increment: function* () {
			let by = arguments[0] === undefined ? 1 : arguments[0];
			let column = arguments[1] === undefined ? _.findKey(_columns, type => type === 'counter') : arguments[1];
   ...
   */
		decrement: function* () {
			let column = arguments[0] === undefined ? _.findKey(_columns, type => type === 'counter') : arguments[0];
			let by = arguments[1] === undefined ? 1 : arguments[1];
